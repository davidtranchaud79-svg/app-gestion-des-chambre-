...
function receiptMessageHtml_() {
  ...
  if (!message) return '';
  return [
    '<div style="margin-top:16px;padding:12px;border-radius:8px;background:#f8fafc;border:1px solid #e2e8f0;color:#334155">',
    '<h3 style="margin:0 0 8px;color:#334155">Confirmation</h3>',
